...
out.write("G1 Z2,000\n")
for i in range(0,68):
    out.write("G1 X"+str(10)+" Y"+str(5+(i*3.6)-1000)+" \n")
    out.write("G1 X"+str(10+30)+" Y"+str(5+(i*3.6)-1000)+" E"+str(0.20*30)+"\n")
    out.write("G1 X"+str(10+30)+" Y"+str(5+(i*3.6)+1.8-1000)+" \n")
    out.write("G1 X"+str(10)+" Y"+str(5+(i*3.6)+1.8-1000)+" E"+str(0.20*30)+"\n")
out.write("G1 Z2,500\n")
for i in range(0,68):
    out.write("G1 X"+str(10)+" Y"+str(5+(i*3.6)-1000)+" \n")
    out.write("G1 X"+str(10+30)+" Y"+str(5+(i*3.6)-1000)+" E"+str(0.20*30)+"\n")
...
for i in range(0,68):
    out.write("G1 X"+str(10)+" Y"+str(5+(i*3.6)-1000)+" \n")
    out.write("G1 X"+str(10+30)+" Y"+str(5+(i*3.6)-1000)+" E"+str(0.10*30)+"\n")
    out.write("G1 X"+str(10+30)+" Y"+str(5+(i*3.6)+1.8-1000)+" \n")
    out.write("G1 X"+str(10)+" Y"+str(5+(i*3.6)+1.8-1000)+" E"+str(0.10*30)+"\n")
out.write("G1 Z3.200\n")
for i in range(0,68):
    out.write("G1 X"+str(10)+" Y"+str(5+(i*3.6)-1000)+" \n")
    out.write("G1 X"+str(10+30)+" Y"+str(5+(i*3.6)-1000)+" E"+str(0.10*30)+"\n")
