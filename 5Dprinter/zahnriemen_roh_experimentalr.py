...
doLineY(30,176,(0,-1000))
out.write("G1 Z0.500\n")
doLineX(30,176,(0,-1000))
out.write("G1 Z0.900\n")
doLineY(30,180,(0,-1000))
out.write("G1 Z1.200\n")
doLineX(30,180,(0,-1000))
...
for i in range(0,45):
    ...
    out.write("G1 X"+str(-3)+" Y"+str((i*2)*distance-1000)+" E"+str(0.20*40)+"\n")
    out.write("G1 Z2,000\n")
    out.write("G1 X"+str(-10+50)+" Y"+str((i*2)*distance-1000)+" E"+str(0.20*40)+"\n")
    out.write("G1 X"+str(-10+50)+" Y"+str((i*2+1)*distance-1000)+" \n")
    out.write("G1 X"+str(-10)+" Y"+str((i*2+1)*distance-1000)+" E"+str(0.20*40)+"\n")
out.write("G1 Z2,500\n")
for i in range(0,45):
    out.write("G1 X"+str(-10)+" Y"+str((i*2)*distance-1000)+" \n")
    out.write("G1 X"+str(-10+50)+" Y"+str((i*2)*distance-1000)+" E"+str(0.20*40)+"\n")
...
for i in range(0,45):
    out.write("G1 X"+str(-10)+" Y"+str((i*2)*distance-1000)+" \n")
    out.write("G1 X"+str(-10+50)+" Y"+str((i*2)*distance-1000)+" E"+str(0.10*40)+"\n")
    out.write("G1 X"+str(-10+50)+" Y"+str((i*2+1)*distance-1000)+" \n")
    out.write("G1 X"+str(-10)+" Y"+str((i*2+1)*distance-1000)+" E"+str(0.10*40)+"\n")
out.write("G1 Z3.200\n")
for i in range(0,45):
    out.write("G1 X"+str(-10)+" Y"+str((i*2)*distance-1000)+" \n")
    out.write("G1 X"+str(-10+50)+" Y"+str((i*2)*distance-1000)+" E"+str(0.10*40)+"\n")
