...
for step in range(0,500):
    ...
    for i in range(0,19):
        start -= width/2.0
        out.write("G1 Z"+str(z+0.5)+" X"+str(x-1.0)+" Y"+str(start)+" E "+str(amount*2.5)+" F800\n")
        start -= width/2.0
        out.write("G1 Z"+str(z-0.2)+" X"+str(x+2.0)+" Y"+str(start)+" E"+str(amount*3)+" F800\n")
        start -= width/2.0
        out.write("G1 Z"+str(z-0.2)+" X"+str(x+2.0)+" Y"+str(start)+" E"+str(amount*2.5)+" F800\n")
        start -= width/2.0
        out.write("G1 Z"+str(z+0.5)+" X"+str(x-1.0)+" Y"+str(start)+" E"+str(amount*3)+" F800\n")
