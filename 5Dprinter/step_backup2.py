...
for step in range(0,100):
    ...
    for i in range(0,36):
        out.write("G1 Z"+str(z-0.2)+" X"+str(x)+" Y"+str(start+width*i)+" E"+str(amount*abs(width))+" F1600\n")
        out.write("G1 Z"+str(z+0.5)+" X"+str(x-stepSize)+" Y"+str(start+width*i)+" E"+str(amount*stepSize)+" F1600\n")
        out.write("G1 Z"+str(z+0.2))
        out.write("G1 Z"+str(z-0.2)+" X"+str(x)+" Y"+str(start+width*i)+" F1600\n")
