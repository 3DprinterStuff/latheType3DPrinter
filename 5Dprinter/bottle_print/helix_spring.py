...
for z in range(0,10):
    ...
    for i in range(0,length):
        if i%2:
            out.write("G1 X%f Y%f E%f F%f\n" % (0.16*(i+1)-shift/2.0+xOffset,-10.20833*(i+1)+yOffset,amount*10.20833,speed))
        else:
            out.write("G1 X%f Y%f E%f F%f\n" % (0.16*(i+1)+shift/2.0+xOffset,-10.20833*(i+1)+yOffset,amount*10.20833,speed))
    ...
    for i in range(0,length):
        if i%2:
            out.write("G1 X%f Y%f E%f\n" % ((length*0.16)-0.16*(i+1)-shift/2.0+xOffset,(-length*10.20833)+10.20833*(i+1)+yOffset,amount*10.20833))
        else:
            out.write("G1 X%f Y%f E%f\n" % ((length*0.16)-0.16*(i+1)+shift/2.0+xOffset,(-length*10.20833)+10.20833*(i+1)+yOffset,amount*10.20833))
