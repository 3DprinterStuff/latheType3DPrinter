...
for z in range(0,20):
    ...
    for i in range(0,length):
        if i%2:
            out.write("G1 X%f Y%f E%f F%f\n" % (0.16*(i+1)-shift/2.0+xOffset,-10*(i+1)+yOffset,amount*10,speed))
        else:
            out.write("G1 X%f Y%f E%f F%f\n" % (0.16*(i+1)+shift/2.0+xOffset,-10*(i+1)+yOffset,amount*10,speed))
    ...
    for i in range(0,length):
        if i%2:
            out.write("G1 X%f Y%f E%f\n" % ((length*0.16)-0.16*(i+1)+shift/2.0+xOffset,(-length*10)+10*(i+1)+yOffset,amount*10))
        else:
            out.write("G1 X%f Y%f E%f\n" % ((length*0.16)-0.16*(i+1)-shift/2.0+xOffset,(-length*10)+10*(i+1)+yOffset,amount*10))
