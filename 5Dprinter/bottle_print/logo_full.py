...
for i in range(-90,-20):
    out.write("G1 X%f Y%f E%f F%f\n" % (-11,i,amount*70,speed))
    out.write("G1 X%f Y%f E%f F%f\n" % (39,i,amount*70,speed))
out.write("G1 Z"+str(1.8)+" F"+str(speed)+"\n")
for i in reversed(range(-9,40)):
...
with open("logo.gcode") as includedFile:
    e = 4.5
    counter = 0
