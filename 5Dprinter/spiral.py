out = open("spiral_fancy_short_2.gcode","w")
...
for z in range(0,20):
    ...
    if z == 0:
        ...
        for step in range(0,50):
            out.write("G1 X"+str(0.16*(i+2)+xOffset+step*0.05)+" Y"+str(-10*(i+2)+yOffset-step*10)+" E"+str(amount*10)+"\n")
    ...
    for i in range(0,length):
        if i%2:
            out.write("G1 X%f Y%f E%f\n" % ((length*0.16)-0.16*(i+1)+xOffset,(-length*10)+10*(i+1)+yOffset,amount*10))
        else:
